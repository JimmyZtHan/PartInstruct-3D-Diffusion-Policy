...
class PointNetEncoderXYZ(nn.Module):
    ...
    def __init__(self,
        ...
        cprint(f"PointNetEncoderXYZ only supports 3 channels, but got {in_channels}", "red")
...
class DP3Encoder(nn.Module):
    def __init__(self, 
        ...
        self.part_point_cloud_key = 'agentview_part_pcd'
        ...
        if self.use_part_mask:
            self.point_cloud_key = self.part_point_cloud_key
        ...
        if pointnet_type == "pointnet":
            ...
            if use_part_mask:
                pointcloud_encoder_cfg.in_channels = 4 # one additional channel for part mask (DP3-S)
                self.extractor = PointNetEncoderXYZRGB(**pointcloud_encoder_cfg)
            else:
